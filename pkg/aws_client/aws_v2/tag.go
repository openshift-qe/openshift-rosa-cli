...
func (client *AwsV2Client) TagResource(resourceID string, tags map[string]string) (*ec2.CreateTagsOutput, error) {
	awsTags := []types.Tag{}
...
func (client *AwsV2Client) RemoveResourceTag(resourceID string, tagKey string, tagValue string) (*ec2.DeleteTagsOutput, error) {
	tags := []types.Tag{
		types.Tag{
			Key:   &tagKey,
			Value: &tagValue,
